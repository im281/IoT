namespace CreateDeviceIdentity
{
    ...
    public class Program
    {
        ...
        private const string ConnectionString = "HostName=QExactiveStream.azure-devices.net;SharedAccessKeyName=registryReadWrite;SharedAccessKey=KH3FUR616IIw/UeNm8MLyTdpqBr6xYrC2QIjgzktrpE=";
        private const string Name = "createdeviceidentity";
        private const string DeviceId = "ImansDataSimulator";
